    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request
                        .requestMatchers(Constants.ENPOINTS_PERMIT_LOGIN, Constants.ENPOINTS_PERMIT_REGISTER, Constants.ENPOINTS_PERMIT_REGISTER_ADMIN).permitAll()
                        .requestMatchers(Constants.ENPOINTS_USER_DNI, Constants.ENPOINTS_USER_LISTA).hasAnyAuthority(Role.USER.name(), Role.ADMIN.name())
